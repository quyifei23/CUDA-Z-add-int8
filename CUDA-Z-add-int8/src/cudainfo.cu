...
__device__ unsigned char __mul8(unsigned char a,unsigned char b) {
	unsigned int result = (unsigned char)a * (unsigned char)b;
...
#define CZ_CALC_MODE_INTEGER8	3	/*!< 8-bit integer test mode. */
